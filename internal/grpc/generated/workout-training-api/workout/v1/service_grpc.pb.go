...
const (
	...
	WorkoutService_ScheduleWorkout_FullMethodName = "/workout_training_api.ping.v1.WorkoutService/ScheduleWorkout"
)
...
type WorkoutServiceClient interface {
	...
	ScheduleWorkout(ctx context.Context, in *ScheduleWorkoutRequest, opts ...grpc.CallOption) (*ScheduleWorkoutResponse, error)
}
...
func (c *workoutServiceClient) ScheduleWorkout(ctx context.Context, in *ScheduleWorkoutRequest, opts ...grpc.CallOption) (*ScheduleWorkoutResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ScheduleWorkoutResponse)
	err := c.cc.Invoke(ctx, WorkoutService_ScheduleWorkout_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WorkoutServiceServer interface {
	...
	ScheduleWorkout(context.Context, *ScheduleWorkoutRequest) (*ScheduleWorkoutResponse, error)
...
func (UnimplementedWorkoutServiceServer) ScheduleWorkout(context.Context, *ScheduleWorkoutRequest) (*ScheduleWorkoutResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ScheduleWorkout not implemented")
}
...
func _WorkoutService_ScheduleWorkout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScheduleWorkoutRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkoutServiceServer).ScheduleWorkout(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorkoutService_ScheduleWorkout_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkoutServiceServer).ScheduleWorkout(ctx, req.(*ScheduleWorkoutRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WorkoutService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ScheduleWorkout",
			Handler:    _WorkoutService_ScheduleWorkout_Handler,
		},
	},
