...
// 	protoc        v3.21.12
// source: workout-training-api/workout/v1/delete_workout.proto
...
func (x *DeleteWorkoutRequest) Reset() {
	*x = DeleteWorkoutRequest{}
	mi := &file_workout_training_api_workout_v1_delete_workout_proto_msgTypes[0]
...
func (*DeleteWorkoutRequest) Descriptor() ([]byte, []int) {
	return file_workout_training_api_workout_v1_delete_workout_proto_rawDescGZIP(), []int{0}
}
...
var File_workout_training_api_workout_v1_delete_workout_proto protoreflect.FileDescriptor

var file_workout_training_api_workout_v1_delete_workout_proto_rawDesc = string([]byte{
	...
	0x31, 0x2f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x5f, 0x77, 0x6f, 0x72, 0x6b, 0x6f, 0x75, 0x74,
...
var (
	file_workout_training_api_workout_v1_delete_workout_proto_rawDescOnce sync.Once
	file_workout_training_api_workout_v1_delete_workout_proto_rawDescData []byte
)

func file_workout_training_api_workout_v1_delete_workout_proto_rawDescGZIP() []byte {
	file_workout_training_api_workout_v1_delete_workout_proto_rawDescOnce.Do(func() {
		file_workout_training_api_workout_v1_delete_workout_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_workout_training_api_workout_v1_delete_workout_proto_rawDesc), len(file_workout_training_api_workout_v1_delete_workout_proto_rawDesc)))
	})
	return file_workout_training_api_workout_v1_delete_workout_proto_rawDescData
}
...
func init() { file_workout_training_api_workout_v1_delete_workout_proto_init() }
func file_workout_training_api_workout_v1_delete_workout_proto_init() {
	if File_workout_training_api_workout_v1_delete_workout_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_workout_training_api_workout_v1_delete_workout_proto_rawDesc), len(file_workout_training_api_workout_v1_delete_workout_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_workout_training_api_workout_v1_delete_workout_proto_goTypes,
		DependencyIndexes: file_workout_training_api_workout_v1_delete_workout_proto_depIdxs,
		MessageInfos:      file_workout_training_api_workout_v1_delete_workout_proto_msgTypes,
	}.Build()
	File_workout_training_api_workout_v1_delete_workout_proto = out.File
	file_workout_training_api_workout_v1_delete_workout_proto_goTypes = nil
	file_workout_training_api_workout_v1_delete_workout_proto_depIdxs = nil
}
