...
func (ec *executionContext) _Workout_scheduledDate(ctx context.Context, field graphql.CollectedField, obj *model.Workout) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Workout_scheduledDate(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Workout_scheduledDate(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Workout",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Workout_status(ctx context.Context, field graphql.CollectedField, obj *model.Workout) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Workout_status(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) unmarshalInputExerciseInput(ctx context.Context, obj any) (model.ExerciseInput, error) {
	...
	fieldsInOrder := [...]string{"id", "name", "description", "muscleGroup", "category", "repetitions", "sets", "weight"}
...
func (ec *executionContext) unmarshalInputWorkoutInput(ctx context.Context, obj any) (model.WorkoutInput, error) {
	...
	fieldsInOrder := [...]string{"id", "name", "exercises", "description", "scheduledDate", "status"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) _Workout(ctx context.Context, sel ast.SelectionSet, obj *model.Workout) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "scheduledDate":
			out.Values[i] = ec._Workout_scheduledDate(ctx, field, obj)
		case "status":
