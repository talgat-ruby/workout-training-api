...
type ComplexityRoot struct {
	Mutation struct {
		CreateWorkout func(childComplexity int, workout model.Workout) int
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.createWorkout":
		...
		return e.complexity.Mutation.CreateWorkout(childComplexity, args["workout"].(model.Workout)), true
...
//go:embed "schema/auth.directives.graphqls" "schema/auth.mutation.graphqls" "schema/workout.mutation.graphqls" "schema/ping.graphqls" "schema/ping.query.graphqls"
